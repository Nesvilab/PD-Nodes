...
**Step 1.** Download the latest version of MSFragger-PDv22.rar or MSFragger-PDv23.rar (depending on your version of Proteome Discoverer) from our github [repository](https://github.com/nesvilab/PD-Nodes/releases/) and unzip/decompress the file. Make sure the JAR (.jar extension) file is in the same directory as the ‘ext’ folder, which contains the libraries needed for reading raw files directly.
